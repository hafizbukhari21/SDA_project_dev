                        ...
                        <form class="user row" id="addTimeSheet">
                            ...
                            <div class="col-lg-6 row">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <select class="form-control" id="select_role" name="user_creator_id" aria-label="Default select example" required>
                            ...
                            <div class="col-lg-6 row">
                                <div class="form-group col-lg-12 ">
                                    ...
                                    <input type="email" class="form-control " name="title" id="project_name"placeholder="Title" required>
                                </div>
                                <div class="form-group col-lg-12" id="HeadPart">
                                    <label for="">Select Head</label>
                                    <select class="form-control" id="" name="user_creator_id" aria-label="Default select example" required>
