...
function AlertifyFailed(data){ 
    ...
    <div style="justify-content: left;text-align: left;">
        ...
        <br>
        <div class="progress">
        <div class="progress-bar bg-danger" role="progressbar" style="width: ${duration/data.duration*100}%" aria-valuenow="${duration/data.duration*100}" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
    </div>
    `);
    },1000);
